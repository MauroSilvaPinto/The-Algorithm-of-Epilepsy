'''
   This simulation:
       ...
       and then a focal seizure with propagation to other two regions
       ...
       In iteration 50:
          a generalised seizure discharge will burst in coordinates [125,125]
          this region will be big
...
# from where I randomnly choose one.
seizure_prob_onset_neurons=np.linspace(0.10,0.80,31)
